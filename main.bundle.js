...
const isolate_1 = __webpack_require__(39);
const dom_1 = __webpack_require__(16);
const Checkbox_1 = __webpack_require__(104);
__webpack_require__(105);
function main(sources) {
    const CB_ALL = isolate_1.default(Checkbox_1.default), cb_all = CB_ALL({ dom: sources.dom, checked$: xstream_1.default.of(false), caption$: xstream_1.default.of("All") }), CB_CAT = isolate_1.default(Checkbox_1.default), cb_cat = CB_CAT({ dom: sources.dom, checked$: cb_all.checked$, caption$: xstream_1.default.of("Cat") }), CB_DOG = isolate_1.default(Checkbox_1.default), cb_dog = CB_DOG({ dom: sources.dom, checked$: cb_all.checked$, caption$: xstream_1.default.of("Dog") }), CB_FISH = isolate_1.default(Checkbox_1.default), cb_fish = CB_FISH({ dom: sources.dom, checked$: cb_all.checked$, caption$: xstream_1.default.of("Fish") }), CB_BULL = isolate_1.default(Checkbox_1.default), cb_bull = CB_BULL({ dom: sources.dom, checked$: cb_all.checked$, caption$: xstream_1.default.of("Bull") }), CB_COW = isolate_1.default(Checkbox_1.default), cb_cow = CB_COW({ dom: sources.dom, checked$: cb_all.checked$, caption$: xstream_1.default.of("Cow") }), cbDom$ = xstream_1.default.combine(cb_all.dom, cb_cat.dom, cb_dog.dom, cb_fish.dom, cb_bull.dom, cb_cow.dom)
        .map(childrenDom => dom_1.div(".checkboxes_holder", childrenDom));
    const dom$ = xstream_1.default.combine(cbDom$)
        .map(([cbDOM]) => {
        return dom_1.div(".main-holder", [
            ,
            dom_1.div('Fancy Task'),
            cbDOM
        ]);
    }), sinks = {
        dom: dom$
...
var MapPolyfill = __webpack_require__(23);
...
function Checkbox(sources) {
    const userChecked$ = sources.dom.select(".checkbox").events("click")
        .map(event => !hasClass(event.currentTarget, "checked")), checked$ = xstream_1.default.merge(userChecked$, sources.checked$)
        .remember(), dom$ = xstream_1.default.combine(checked$, sources.caption$)
        .map(([checked, caption]) => {
        return dom_1.div(".checkbox", { class: { checked } }, [
            dom_1.div(".checkbox_input"),
            dom_1.div(".checkbox_caption", caption)
        ]);
    });
    return {
        dom: dom$,
